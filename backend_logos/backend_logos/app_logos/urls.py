...
urlpatterns = [
    ...
    # --- FIX DEFINITIVO PARA ERROR 404 ---
    # Esta ruta actúa como un alias para capturar la redirección incorrecta de Django.
    path('accounts/login/', views.login_view, name='account_login_proxy'),
